...
class Config:
    ...
    def __init__(self, config_file: Optional[str] = None):
        ...
        ha_discovery_value = os.getenv('HA_DISCOVERY', file_config.get('ha_discovery', True))
        if isinstance(ha_discovery_value, bool):
            self.ha_discovery = ha_discovery_value
        else:
            self.ha_discovery = str(ha_discovery_value).lower() == 'true'
        ...
        self.device_name = os.getenv('DEVICE_NAME', file_config.get('device_name', 'Skoda Enyaq'))
        self.device_manufacturer = os.getenv('DEVICE_MANUFACTURER', file_config.get('device_manufacturer', 'Skoda'))
        self.device_model = os.getenv('DEVICE_MODEL', file_config.get('device_model', 'Enyaq iV'))
